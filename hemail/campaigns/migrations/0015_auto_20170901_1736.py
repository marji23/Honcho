# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-09-20 08:38
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ('campaigns', '0014_merge_20170828_2121'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='campaign',
            name='contacts',
            field=models.ManyToManyField(through='campaigns.Participation', to='contacts.Contact'),
        ),
        migrations.AddField(
            model_name='step',
            name='campaign',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='steps',
        ...
        migrations.AddField(
            model_name='step',
            name='timezone',
            field=timezone_utils.fields.TimeZoneField(choices=[('Africa/Abidjan', 'Africa/Abidjan'), ('Africa/Accra', 'Africa/Accra'),
                                                               ...
                                                               ('America/Cancun', 'America/Cancun'), ('America/Caracas', 'America/Caracas'),
                                                               ...
                                                               ('Asia/Tehran', 'Asia/Tehran'), ('Asia/Thimphu', 'Asia/Thimphu'),
                                                               ('Asia/Tokyo', 'Asia/Tokyo'), ('Asia/Tomsk', 'Asia/Tomsk'),
                                                               ...
                                                               ('UTC', 'UTC')], default='US/Pacific', max_length=32),
        ),
        migrations.AddField(
            model_name='step',
            name='weekdays',
            field=django.contrib.postgres.fields.ArrayField(
                base_field=enumfields.fields.EnumField(enum=campaigns.models.Weekdays, max_length=3),
                default=[campaigns.models.Weekdays('SUN'), campaigns.models.Weekdays('MON'), campaigns.models.Weekdays('TUE'),
                         campaigns.models.Weekdays('WED'), campaigns.models.Weekdays('THU'), campaigns.models.Weekdays('FRI'),
                         campaigns.models.Weekdays('SAT')], size=7, validators=[common.validators.array_unique_elements_validator]),
        ),
        migrations.DeleteModel(
            name='Template',
        ),
        ...
        migrations.AddField(
            ...
            name='step',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='emails', to='campaigns.Step'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='textstage',
            name='step',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='texts', to='campaigns.Step'),
            preserve_default=False,
        ),
        migrations.RemoveField(
            model_name='emailstage',
        ...
        migrations.AddField(
            model_name='emailstage',
            name='emailtemplate_ptr',
            field=models.OneToOneField(auto_created=True, default=None, on_delete=django.db.models.deletion.CASCADE, parent_link=True,
                                       primary_key=True, serialize=False, to='post_office.EmailTemplate'),
            preserve_default=False,
        ),
